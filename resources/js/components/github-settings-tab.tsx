...
import { destroy as githubDestroy, auth as githubAuth } from '@/routes/projects/github';
...
export function GithubSettingsTab({
    ...
    function handleDisconnect() {
        ...
        router.delete(
            githubDestroy.url({ workspace: workspaceSlug, project: projectSlug }),
            {
                preserveScroll: true,
            ...
            <CardContent className="flex flex-col gap-4">
                {isConnected ? (
                        ...
                        <div className="flex items-center gap-3 rounded-md border p-3">
                            ...
                            <div className="min-w-0 flex-1">
                                <p className="text-sm font-medium">
                                    {meta?.name ?? meta?.nickname ?? 'Connected'}
                                </p>
                    ...
                    <div>
                        ...
                        >
                            <a
                                href={githubAuth.url({ workspace: workspaceSlug, project: projectSlug })}
